...
public class AppDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bank>().HasData(
            new Bank { Id = 1, Code = "BNA", Name = "BNA - Banque Nationale d'Algérie", PositionsJson = defaultPositions, CreatedAt = DateTime.UtcNow },
            new Bank { Id = 2, Code = "CPA", Name = "CPA - Crédit Populaire d'Algérie", PositionsJson = defaultPositions, CreatedAt = DateTime.UtcNow },
            new Bank { Id = 3, Code = "BEA", Name = "BEA - Banque Extérieure d'Algérie", PositionsJson = defaultPositions, CreatedAt = DateTime.UtcNow }
        );
    }
}
