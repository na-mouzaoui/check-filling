    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onCancel()}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Veuillez suivre ces instructions pour une impression correcte du chèque</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border bg-muted p-4">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Placez le chèque vierge dans l'imprimante avec le haut du chèque orienté vers le haut, centré dans le bac
              d'alimentation.
            </p>
          </div>
          ...
          <div className="rounded-lg border bg-muted p-4">
            ...
            <ul className="ml-10 space-y-1 text-sm text-muted-foreground">
              <li>• Format: A4 ou format chèque personnalisé</li>
              <li>• Qualité: Normale ou supérieure</li>
          ...
          <div className="flex items-start space-x-2 rounded-lg border p-4">
            ...
            <div className="grid gap-1.5 leading-none">
              ...
              <p className="text-sm text-muted-foreground">
                Les données saisies correspondent au chèque à imprimer et le chèque est correctement positionné
              </p>
            </div>
          </div>
        </div>
