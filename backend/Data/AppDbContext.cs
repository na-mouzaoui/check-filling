...
public class AppDbContext : DbContext
{
    ...
    {
        // Tous les utilisateurs ont le même mot de passe: test1234
        ...
        modelBuilder.Entity<Region>().HasData(
            new Region { Id = 1, Name = "nord", WilayasJson = "[\"Alger\", \"Tipaza\", \"Boumerdes\", \"Blida\", \"Ain Defla\"]", CreatedAt = seedCreatedAt },
            new Region { Id = 2, Name = "sud", WilayasJson = "[\"Ouargla\", \"Ghardaia\", \"Tamanrasset\", \"Adrar\", \"Illizi\"]", CreatedAt = seedCreatedAt },
            new Region { Id = 3, Name = "est", WilayasJson = "[\"Constantine\", \"Annaba\", \"Sétif\", \"Batna\", \"Guelma\"]", CreatedAt = seedCreatedAt },
            new Region { Id = 4, Name = "ouest", WilayasJson = "[\"Oran\", \"Tlemcen\", \"Sidi Bel Abbès\", \"Mostaganem\", \"Mascara\"]", CreatedAt = seedCreatedAt }
        );
    }
}
